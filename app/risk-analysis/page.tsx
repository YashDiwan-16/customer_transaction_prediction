              ...
              <CardContent className="space-y-4">
                <div className="rounded-md bg-muted p-4">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    {stats.highRiskPercentage.toFixed(1)}% of your customers
                    fall into the high risk category, representing potential
                ...
                <div className="rounded-md bg-muted p-4">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    ...
                    {(stats.averagePastDue * 100).toFixed(1)}%. This suggests
                    there may be opportunities to improve collection processes.
                  </p>
                </div>
